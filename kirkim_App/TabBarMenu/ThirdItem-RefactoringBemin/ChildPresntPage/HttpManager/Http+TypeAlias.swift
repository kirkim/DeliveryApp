//
//  Http+TypeAlias.swift
//  kirkim_App
//
//  Created by 김기림 on 2022/05/26.
//

typealias DetailStoreHttpManager = DetailStoreHttpModel
typealias SummaryStoreHttpManager = SummaryStoreHttpModel
